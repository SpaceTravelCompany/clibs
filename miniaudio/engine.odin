...
sound :: struct {
	...
	pProcessingCache:            [^]f32, /* Will be null if pDataSource is null. */
	processingCacheFramesRemaining: u32,
	processingCacheCap:          u32,
...
engine_config :: struct {
	...
	resampling:           resampler_config,  /* The resampling config to use with the resource manager. */
	pitchResampling:      resampler_config,   /* The resampling config for the pitch and Doppler effects. You will typically want this to be a fast resampler. For high quality stuff, it's recommended that you pre-resample. */
}
