//odin binding from https://github.com/xiph/opus
package opus
 ...
 */
	@(require_results)
	opus_encoder_create :: proc(Fs: opus_int32, channels: int, application: c.int, error: ^c.int) -> ^OpusEncoder ---
 ...
 *                                      24000, or 48000.
  ...
  */
	@(require_results)
	opus_encode :: proc(st: ^OpusEncoder, pcm: [^]opus_int16, frame_size: c.int, data: [^]byte, max_data_bytes: opus_int32) -> opus_int32 ---
  ...
  */
	@(require_results)
	opus_encode_float :: proc(st: ^OpusEncoder, pcm: [^]c.float, frame_size: c.int, data: [^]byte, max_data_bytes: opus_int32) -> opus_int32 ---
  ...
  */
	@(require_results)
	opus_decoder_get_size :: proc(channels: c.int) -> c.int ---
  ...
  */
	@(require_results)
	opus_decoder_create :: proc(Fs: opus_int32, channels: int, error: ^c.int) -> ^OpusDecoder ---
  ...
  */
	@(require_results)
	opus_decode :: proc(st: ^OpusDecoder, data: [^]byte, len: opus_int32, pcm: [^]opus_int16, frame_size: c.int, decode_fec: c.int) -> c.int ---
  ...
  */
	@(require_results)
	opus_decode_float :: proc(st: ^OpusDecoder, data: [^]byte, len: opus_int32, pcm: [^]c.float, frame_size: c.int, decode_fec: c.int) -> c.int ---
  ...
  */
    ...
    */
	opus_dred_parse :: proc(dred_dec: ^OpusDREDDecoder, dred: ^OpusDRED, data: [^]byte, len: opus_int32, max_dred_samples: opus_int32, sampling_rate: opus_int32, dred_end: c.int, defer_processing: c.int) -> c.int ---
    ...
    */
	opus_packet_parse :: proc(data: [^]byte,
		len: opus_int32,
		out_toc: ^byte,
		frames: [^]byte, //len 48
		size: [^]opus_int16, //len 48
		payload_offset: ^c.int,) -> c.int ---
    ...
    */
	@(require_results)
	opus_packet_get_bandwidth :: proc(data: [^]byte) -> c.int ---
    ...
    */
	@(require_results)
	opus_packet_get_samples_per_frame :: proc(data: [^]byte, Fs: opus_int32) -> c.int ---
    ...
    */
	@(require_results)
	opus_packet_get_nb_channels :: proc(data: [^]byte) -> c.int ---
    ...
    */
	@(require_results)
	opus_packet_get_nb_frames :: proc(packet: [^]byte, len: opus_int32) -> c.int ---
    ...
    */
	@(require_results)
	opus_packet_get_nb_samples :: proc(packet: [^]byte, len: opus_int32, Fs: opus_int32) -> c.int ---
    ...
    */
	@(require_results)
	opus_packet_has_lbrr :: proc(packet: [^]byte, len: opus_int32) -> c.int ---
    ...
    */
	@(require_results)
	opus_decoder_get_nb_samples :: proc(dec: ^OpusDecoder, packet: [^]byte, len: opus_int32) -> c.int ---
    ...
    */
	@(require_results)
	opus_repacketizer_get_size :: proc() -> c.int ---
  ...
  * opus_repacketizer_init().
    */
	@(require_results)
	opus_repacketizer_create :: proc() -> ^OpusRepacketizer ---
    ...
    */
	@(require_results)
	opus_repacketizer_out_range :: proc(rp: ^OpusRepacketizer, begin: c.int, end: c.int, data: [^]byte, maxlen: opus_int32) -> opus_int32 ---
    ...
    */
	@(require_results)
	opus_repacketizer_get_nb_frames :: proc(rp: ^OpusRepacketizer) -> c.int ---
    ...
    */
	@(require_results)
	opus_repacketizer_out :: proc(rp: ^OpusRepacketizer, data: [^]byte, maxlen: opus_int32) -> opus_int32 ---
    ...
    */
	@(require_results)
	opus_packet_unpad :: proc(data: [^]byte, len: opus_int32) -> opus_int32 ---
    ...
    */
	@(require_results)
	opus_multistream_packet_unpad :: proc(data: [^]byte, len: opus_int32, nb_streams: c.int) -> opus_int32 ---
	//opus.h end
  ...
  */
	@(require_results)
	opus_multistream_encoder_get_size :: proc(streams: c.int, coupled_streams: c.int) -> opus_int32 ---

	@(require_results)
	opus_multistream_surround_encoder_get_size :: proc(channels: c.int, mapping_family: c.int) -> opus_int32 ---
...
*/
	@(require_results)
	opus_multistream_encoder_create :: proc(Fs: opus_int32, channels: c.int, streams: c.int, coupled_streams: c.int, mapping: [^]byte, application: c.int, error: ^c.int) -> ^OpusMSEncoder ---

	@(require_results)
	opus_multistream_surround_encoder_create :: proc(Fs: opus_int32, channels: c.int, mapping_family: c.int, streams: [^]c.int, coupled_streams: [^]c.int, mapping: [^]byte, application: c.int, error: ^c.int) -> ^OpusMSEncoder ---
...
*          on failure.
*/
	opus_multistream_encoder_init :: proc(st: ^OpusMSEncoder, Fs: opus_int32, channels: c.int, streams: c.int, coupled_streams: c.int, mapping: [^]byte, application: c.int) -> c.int ---

	opus_multistream_surround_encoder_init :: proc(st: ^OpusMSEncoder, Fs: opus_int32, channels: c.int, mapping_family: c.int, streams: [^]c.int, coupled_streams: [^]c.int, mapping: [^]byte, application: c.int) -> c.int ---
...
*/
	@(require_results)
	opus_multistream_encode :: proc(st: ^OpusMSEncoder, pcm: [^]c.uint16_t, frame_size: c.int, data: [^]byte, max_data_bytes: opus_int32) -> c.int ---
...
*/
	@(require_results)
	opus_multistream_encode_float :: proc(st: ^OpusMSEncoder, pcm: [^]c.float, frame_size: c.int, data: [^]byte, max_data_bytes: opus_int32) -> c.int ---
...
*/
	@(require_results)
	opus_multistream_decoder_get_size :: proc(streams: c.int, coupled_streams: c.int) -> opus_int32 ---
...
*/
	@(require_results)
	opus_multistream_decoder_create :: proc(Fs: opus_int32, channels: c.int, streams: c.int, coupled_streams: c.int, mapping: [^]byte, error: ^c.int) -> ^OpusMSDecoder ---
...
*          on failure.
*/
	opus_multistream_decoder_init :: proc(st: ^OpusMSDecoder, Fs: opus_int32, channels: c.int, streams: c.int, coupled_streams: c.int, mapping: [^]byte) -> c.int ---
...
*/
	@(require_results)
	opus_multistream_decode :: proc(st: ^OpusMSDecoder, data: [^]byte, len: opus_int32, pcm: [^]opus_int16, frame_size: c.int, decode_fec: c.int) -> c.int ---
...
*/
	@(require_results)
	opus_multistream_decode_float :: proc(st: ^OpusMSDecoder, data: [^]byte, len: opus_int32, pcm: [^]c.float, frame_size: c.int, decode_fec: c.int) -> c.int ---
...
*/
  ...
  */
	@(require_results)
	opus_projection_ambisonics_encoder_get_size :: proc(channels: c.int, mapping_family: c.int) -> opus_int32 ---
...
*/
	@(require_results)
	opus_projection_ambisonics_encoder_create :: proc(Fs: opus_int32, channels: c.int, mapping_family: c.int, streams: [^]c.int, coupled_streams: [^]c.int, mapping: [^]byte, application: c.int, error: ^c.int) -> ^OpusProjectionEncoder ---
...
*          on failure.
*/
	opus_projection_ambisonics_encoder_init :: proc(st: ^OpusProjectionEncoder, Fs: opus_int32, channels: c.int, mapping_family: c.int, streams: [^]c.int, coupled_streams: [^]c.int, application: c.int) -> c.int ---
...
*/
	@(require_results)
	opus_projection_encode :: proc(st: ^OpusProjectionEncoder, pcm: [^]opus_int16, frame_size: c.int, data: [^]byte, max_data_bytes: opus_int32) -> c.int ---
...
*/
	@(require_results)
	opus_projection_encode_float :: proc(st: ^OpusProjectionEncoder, pcm: [^]c.float, frame_size: c.int, data: [^]byte, max_data_bytes: opus_int32) -> c.int ---
...
*/
	@(require_results)
	opus_projection_decoder_get_size :: proc(channels: c.int, streams: c.int, coupled_streams: c.int) -> opus_int32 ---
...
*/
	@(require_results)
	opus_projection_decoder_create :: proc(Fs: opus_int32, channels: c.int, streams: c.int, coupled_streams: c.int, demixing_matrix: [^]byte, demixing_matrix_size: opus_int32, error: ^c.int) -> ^OpusProjectionDecoder ---
...
*          on failure.
*/
	opus_projection_decoder_init :: proc(st: ^OpusProjectionDecoder, Fs: opus_int32, channels: c.int, streams: c.int, coupled_streams: c.int, demixing_matrix: [^]byte, demixing_matrix_size: opus_int32) -> c.int ---
...
*/
	@(require_results)
	opus_projection_decode :: proc(st: ^OpusProjectionDecoder, data: [^]byte, len: opus_int32, pcm: [^]opus_int16, frame_size: c.int, decode_fec: c.int) -> c.int ---
...
*/
	@(require_results)
	opus_projection_decode_float :: proc(st: ^OpusProjectionDecoder, data: [^]byte, len: opus_int32, pcm: [^]c.float, frame_size: c.int, decode_fec: c.int) -> c.int ---
